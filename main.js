Webcam.set({
    ...
    classifier= ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/CSY0--sY-/model.json",modelLoaded);
    function modelLoaded(){
        console.log("Model Loaded");
    }
    
    var synth= window.speechSynthesis;
    var speak_data="This is the image of "+result[0].label;
